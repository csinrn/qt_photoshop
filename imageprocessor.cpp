...
void ImageProcessor::doneModify(){
    done = true;
    destroyWindow("vertices check");

    //  perspectiveTransform
    final = perspectiveTransform(src,shrink);
}
